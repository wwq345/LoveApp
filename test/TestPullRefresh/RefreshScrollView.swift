...
//            if !self.loading, self.offset < -self.threshold, self.preOffset <= self.threshold {
//                self.loading = true
//            }
//
//            if self.loading {
    ...
    struct RefreshHeader: View {
        ...
        var body: some View {
            HStack(spacing: 20) {
                ...
                VStack(spacing: 5) {
                    Text("\(self.loading ? "refreshing" : "pull down to refresh")")
    ...
    struct LoadTrailer: View {
        ...
        var body: some View {
            HStack {
                ...
                VStack {
                    Text("\(self.loading ? "loading" : "pull up to reload")")
                        .foregroundColor(.secondary)
                        .font(.subheadline)
                }
            }
